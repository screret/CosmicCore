...
public class CCoreMaterialIconSet extends MaterialIconSet implements IRenderer {
    ...
    public static final CCoreMaterialIconSet VIBRANIUM = new CCoreMaterialIconSet("vibranium",
            ...
            HaloItemRenderer.create(4, 0xFF489BC3, CosmicCore.id("block/iris/rnd/halo"), true, false));
    public static final CCoreMaterialIconSet VIBRANIUM_NEUTRONIUM = new CCoreMaterialIconSet("vibranium_neutronium",
            ...
            HaloItemRenderer.create(3, 0xFFFFFFFF, CosmicCore.id("block/iris/rnd/compression_halo_neutronium_faded"),
                    true, false));

    // public static final CCoreMaterialIconSet VIBRANIUM_NEUTRONIUM = new CCoreMaterialIconSet("vibranium_neutronium",
    // CosmicMaterialSet.NEUTRONIUM_CCORE, false, LensRender::new);

    public static final CCoreMaterialIconSet PRISMATIC = new CCoreMaterialIconSet("prismatic",
            MaterialIconSet.SHINY, false,
            HaloItemRenderer.create(8, 0xFF1c1926, CosmicCore.id("block/iris/rnd/storm_halo"), true, false));

    public static final CCoreMaterialIconSet CHRONIC = new CCoreMaterialIconSet("chronic",
            CosmicMaterialSet.CHRONON, false,
            HaloItemRenderer.create(8, 0xFF1c1926, CosmicCore.id("block/iris/rnd/time_halo"), true, false));
    ...
    public static final CCoreMaterialIconSet VOIDSPARKICO = new CCoreMaterialIconSet("voidspark_special",
            ...
            HaloItemRenderer.create(4, 0xFFFFFFFF, CosmicCore.id("block/iris/rnd/tentacle_halo"), true, false));
    ...
    public static final CCoreMaterialIconSet STARMETALICO = new CCoreMaterialIconSet("starmetal_special",
            ...
            HaloItemRenderer.create(2, 0xFFFFFFFF, CosmicCore.id("block/iris/rnd/tentacle_halo_glass"), true, true));

    public static final CCoreMaterialIconSet SOL_STEEL = new CCoreMaterialIconSet("sol_steel",
            CosmicMaterialSet.SOL, false,
            HaloItemRenderer.create(4, 0xFFFFFFFF, CosmicCore.id("block/iris/rnd/compression_halo_sol"), true, false));
}
